...
def embed_text(dat_iter, mmap_file, start_idx=None, downsampler=None, skip_idxs=None,  dtype=np.float16, mmap_len=0, embed_dim=25,  embedder="minilm", chunk_size=10000,  universal_embed_mode=None, prototypes=None, universal_downsampler=None, use_tqdm=True):
